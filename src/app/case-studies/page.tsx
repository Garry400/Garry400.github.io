...
export const metadata = {
  title: "Case Studies",
  description: "Case studies of my work UI/UX, Web Development, and more.",
};
...
export default async function BlogPage() {
  ...
  const allPosts = posts.map(post => ({
    ...post,
    type: 'local' as const,
    url: `/case-studies/${post.slug}`, // Or /case-studies/
    isExternal: false,
  ...
  return (
    <section className="max-w-3xl mx-auto px-4 py-16">
      <BlurFade delay={BLUR_FADE_DELAY}>
        <div className="mb-12">
          <h1 className="font-semibold text-2xl mb-1 tracking-tight">case studies</h1>
        </div>
      </BlurFade>
